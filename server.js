...
async function buildMonthlyReport() {
    ...
    if (error) {
        console.error('Telegram report - Supabase error:', error.message);
...
// Send report to the admin chat (used by cron + test route)
...
// Runs at 11:59 PM on 28th–31st — fires only on actual last day of month
